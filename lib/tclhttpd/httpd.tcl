...
proc Httpd_VirtualHosts {hostNames file} {
    ...
    set site [file rootname [file dirname $file]]
    ...
    $slave eval [list array set Config [list config $file host $host site $site siteRoot [file dirname $file]]]
    $slave eval {
	...
	source $Config(main)
        file mkdir [file join $Config(vhostRoot) default weblog]
        set ::Config(Log_File) [file join $Config(vhostRoot) default weblog log]
