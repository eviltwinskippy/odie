...
# 
# RCS: @(#) $Id: s.gregorian.tcl 1.4 03/04/11 19:10:42-00:00 andreas_kupries $
#
#----------------------------------------------------------------------
...
namespace eval ::calendar::GregorianCalendar {
    ...
    namespace import -force ::calendar::CommonCalendar::WeekdayOnOrBefore
    namespace import -force ::calendar::CommonCalendar::CivilYearToAbsolute
